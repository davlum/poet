...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='entitytoentityrel',
            name='from_entity_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ee_from_model', to='app.Entity'),
        ),
        migrations.AlterField(
            model_name='entitytoentityrel',
            name='to_entity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ee_to_model', to='app.Entity'),
        ),
        migrations.AlterField(
            model_name='entitytoworkrel',
            name='from_entity',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ew_from_model', to='app.Entity'),
        ),
        migrations.AlterField(
            model_name='entitytoworkrel',
            name='to_work',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ew_to_model', to='app.Work'),
        ),
        migrations.AlterField(
            model_name='historicalentitytoworkrel',
            name='from_entity',
        ...
        migrations.AlterField(
            ...
            name='from_work',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ww_from_model', to='app.Work'),
        ),
        migrations.AlterField(
            model_name='worktoworkrel',
            name='to_work_id',
